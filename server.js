        ...
        connect: (() => {
            ...
            function incoming(message, socket) {
                ...
                case 'L': { // level up cheat
                    ...
                    // cheatingbois
                    if (player.body != null) { if (player.body.skill.level < c.SKILL_CHEAT_CAP || ((socket.key === process.env.SECRET) && player.body.skill.level < 0)) {
                ...
                case '0': { // testbed cheat
                    if (m.length !== 0) { socket.kick('You do not have the secret, noob.'); return 1; }
                    // cheatingbois
...
var maintainloop = (() => {
    ...
    function placeRoids() {
        ...
        // Start placing them
        let roidcount = room.bas2.length * room.width * room.height / room.xgrid / room.ygrid / 150000 / 1.5;
    ...
    let spawnCrasher = census => {
        if (ran.chance(1 -  0.5 * census.crasher / room.maxFood / room.nestFoodAmount)) {
            ...
            let type = (ran.dice(80)) ? ran.choose([Class.indhornet]) : Class.crasher;
            let o = new Entity(spot);
                o.define(type);
                o.team = -100;
        }
    ...
    let makefood = (() => {
        ...
        function getFoodClass(level) {
            ...
            switch (level) {
                ...
                case 4: a = Class.bigTriangle; break;
                case 5: a = Class.giantTriangle; break;
                case 6: a = Class.bigPentagon; break;
                case 7: a = Class.hugePentagon; break;
                case 8: a = Class.giantPentagon; break;
                case 9: a = Class.omegaPentagon; break;
